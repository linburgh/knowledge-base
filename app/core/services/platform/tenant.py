...
def validate(dto: TenantDto, *, creating: bool = False) -> None:
    ...
    common_validation.validate_free_text(dto.description, "description", max_length=form_limits.RESOURCE_DESCRIPTION)
    common_validation.validate_text(dto.logo, "logo", max_length=form_limits.URL)
    common_validation.validate_free_text(dto.contact_name, "contact_name", max_length=form_limits.PERSON_NAME)
    common_validation.validate_text(dto.contact_email, "contact_email", max_length=form_limits.EMAIL)
